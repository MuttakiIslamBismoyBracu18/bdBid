...
class _LoginState extends State<Login>
{
        ...
        child: Column(
          ...
          children: [
            ...
            FlatButton.icon(
              ...
              icon: (Icon(Icons.nature_people, color: Colors.black87,)),
              label: Text("I'm an Admin", style: TextStyle(
  ...
  FirebaseAuth _auth = FirebaseAuth.instance;
    ...
    Future readData(FirebaseUser f_user) async
    {
      Firestore.instance.collection("users").document(f_user.uid).get().then((dataSnapshot)
      async {
