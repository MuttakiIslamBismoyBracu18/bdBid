        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot> (
              stream: Firestore.instance.collection("items").limit(15).orderBy("publishDate", descending: true).snapshots(),
              builder: (context,dataSnapshot)
              {
                return !dataSnapshot.hasData
              ? SliverToBoxAdapter(child: circularProgress(),)
                : SliverStaggeredGrid.countBuilder(
                crossAxisCount : 1, staggeredTileBuilder: (c) => StaggeredTile.fit(1),
      ...
      child: Container(
        ...
        child: Row(
          children: [
                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "OFF%", style: TextStyle(fontSize:15.0,color:Colors.white, fontWeight: FontWeight.normal),
                              ),
                            ],
                          ),
                        ),
            ...
            //implement the cart item remove
            Align(
...
void checkItemInCart(String shortInfoAsID, BuildContext context)
{
  ...
  ? Fluttertoast.showToast(msg: "You have already bidded on this product")
...
addItemToCart( String shortInfoAsID, BuildContext context)
{
  ...
  EcommerceApp.firestore.collection(EcommerceApp.collectionUser)
    ...
    Fluttertoast.showToast(msg: "Your Bid Price is Submitted");
